...
public class TestParseXml {
  ...
  public static void main(String[] args) {
    try {
      //      TestParseXml cls = new TestParseXml();
      //      cls.test();
      String sss = "792.优享卡";
      String[] sa = sss.split("\\.");
  ...
  public void test() throws Exception {
    ...
    FileInputStream in = new FileInputStream(new File("D:\\pms.xml"));
    ...
    String xpath = "/pom/element/element/element/case/condition[@attribute='memberTag']";
    List<Element> composites = document.selectNodes(xpath);
    for (Element composite : composites) {
      System.out.println(composite.attribute("operand").getValue());
    }
  ...
  public void listNodes(Element node) {
    ...
    for (Attribute attr : list) {
      ...
      //        + "---" + attr.getValue());
      if (attr.getValue().contains("MemberCondition")) {
