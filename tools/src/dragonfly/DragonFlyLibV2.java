...
import dragonfly.abcp.api.BpaasApiDLL;
...
public class DragonFlyLibV2 {
  ...
  private static DragonFlyLibV2 instance = null;
  private BpaasApiDLL dll = null;

  public synchronized static DragonFlyLibV2 getInstance() {
    if (instance == null) {
      instance = new DragonFlyLibV2();
    }
    return instance;
  }
