 ...
 *       &lt;all&gt;
 *         &lt;element name="I_IMPORT" type="{urn:sap-com:document:sap:rfc:functions}ZSPAY_IMPORT" minOccurs="0"/&gt;
...
@XmlRootElement(name = "ZRFC_COMMON_PAY")
public class ZRFCCOMMONPAY {

    @XmlElement(name = "I_IMPORT")
    protected ZSPAYIMPORT iimport;
     ...
     * 获取iimport属性的值。
     *
     * @return possible object is {@link ZSPAYIMPORT }
     */
    public ZSPAYIMPORT getIIMPORT() {
        return iimport;
    }
     ...
     * 设置iimport属性的值。
     *
     * @param value allowed object is {@link ZSPAYIMPORT }
     */
    public void setIIMPORT(ZSPAYIMPORT value) {
        this.iimport = value;
    }
